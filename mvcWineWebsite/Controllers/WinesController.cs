...
using mvcWineWebsite.Models;

namespace mvcWineWebsite.Controllers
{
    public class WinesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "WineID,Name,Vineyard,Description,ImageURL,BottlePrice,CasePrice,Grape")] Wine wine)
        {
            if (ModelState.IsValid)
            {
